...
export const siteSchema = z.object({
    ...
    repere_connu: z.string().trim().optional(),

    latitude: z.string().optional(),
    longitude: z.string().optional(),
    lien_google: z.string().optional(),

    prix_metre_carre: z.string().optional(),
    superficie_total: z.string().optional(),
    superficie_disponible: z.string().optional(),
    ...
    modalite_paiement: z.string().trim().optional(),

    numero_titre_site: z.string().trim().optional(),
    statut_numero_titre_site: z.string().trim().optional(),
    statut_document_site: z.string().trim().optional(),
    procedure_acquisition_site: z.string().trim().optional(),

    niveau_risque_juridique_site: z.string().optional(),

    nom_partenaire_site: z.string().optional(),
    type_fournisseur_site: z.string().trim().optional(),
    ...
    statut_fournisseur_site: z.string().optional(),
    fiabilite_fournisseur_site: z.string().trim().optional(),
